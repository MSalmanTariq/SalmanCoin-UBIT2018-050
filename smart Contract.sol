...
contract salmanCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function salmanCoin() {
        ...
        name = "salmanCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = 'UBIT2018-050';                                             // Set the symbol for display purposes (CHANGE THIS)
